...
Conecta Coding Box a STEAMakersBlocks mediante un cable USB, por en marcha "Connector" y haz clic en el botón "Subir" para cargar el código. Haz clic en la flechita a la derecha de "Consola" y abre "Serial plotter". Cubre el sensor con la mano y verás el valor decrecer.

![Resultado 5. Fotoresistencia o LDR](../img/SMB/R5_Fotoresistencia.png){.center-img100}
