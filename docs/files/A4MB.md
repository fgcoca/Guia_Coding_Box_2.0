...
**2.-** ![Bloque_Tones](../img/MB/B_MIDI.png){.img40} toca las notas especificadas por los números de clave (0-127) en el piano, donde el Do central es el 60. Este bloque realiza conversiones matemáticas en la música (por ejemplo, transposición a otra tonalidad).
...
**3.-** ![Bloque_Tones](../img/MB/B_frec.png){.img40} reproduce las notas especificadas en hercios (Hz). El Do central es de aproximadamente 261 Hz, y el La agudo es de 440 Hz (la nota con la que afina la orquesta).

**4.-** ![Bloque_Tones](../img/MB/B_frec_solo.png){.img30} empieza a reproducir de forma continua el tono especificado en hercios (Hz).

**5.-** ![Bloque_Tones](../img/MB/deten.png){.img20} deja de reproducirse.

**6.-** ![Bloque_Tones](../img/MB/B_ini_zumbador.png){.img30} establece el pin para reproducir el tono. Conecta el zumbador piezoeléctrico o los auriculares a este pin. En el caso de una placa con altavoz integrado, si se omite este bloque, se utilizará el altavoz integrado.
