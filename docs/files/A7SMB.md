...
* ![Bloque](../img/SMB/B_crear_texto_con.png) Se utiliza para crear un texto a partir de la unión de otros textos o variables. El bloque convierte las variables utilizadas en texto. El bloque se puede expandir (o contraer) a mas (o menos) líneas. Tambien se puede escoger hacer un salto de línea al final del texto unido o no crearlo.
* ![Bloque](../img/SMB/B_texto.png) Para definir una cadena de texto, o un caracter, de forma estática.

==**De Sensores:**==

* ![Bloque](../img/SMB/B_distancia_cm.png) El bloque devuelve la distancia en centímetros del obstáculo detectado por la señal de ultrasonidos emitida por el pin Trigger (IO5) al recibir el rebote en el pin Echo (IO4). El margen de medida está entre los 2 cm y los 400 cm.

### <FONT COLOR=#AA0000>Prueba del código</font>
Puedes crear los bloques manualmente o abrir directamente el archivo de código que te puedes descargar del enlace: [7. Sensor de ultrasonidos](../programas/SMB/Act/A7SMB.abp).

El programa es el siguiente:

![7. Sensor de ultrasonidos](../img/SMB/7_Sensor_ultrasonidos.png){.center-img100}  
[7. Sensor de ultrasonidos](../programas/SMB/Act/A7SMB.abp){.enlace-centrado}

### <FONT COLOR=#AA0000>Resultado de la prueba</font>
Conecta Coding Box a STEAMakersBlocks mediante un cable USB, por en marcha "Connector" y haz clic en el botón "Subir" para cargar el código. Haz clic en la flechita a la derecha de "Consola", abrela y configura la velocidad. Si mueves la mano delante del sensor ultrasónico o te desplazas hacia adelante y hacia atrás, podrás ver cómo cambian los valores de distancia que se muestran en pantalla.

![Resultado 7. Sensor de ultrasonidos](../img/SMB/R7_Sensor_ultrasonidos.png){.center-img75}
